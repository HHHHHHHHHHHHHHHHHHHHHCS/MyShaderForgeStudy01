...
////// Lighting:
////// Emissive:
                float4 node_8089 = _Time;
                float2 node_5302 = (i.uv0+node_8089.g*float2(0.3,0));
                float4 _MainTexture_var = tex2D(_MainTexture,TRANSFORM_TEX(node_5302, _MainTexture));
                float2 node_1532 = (i.uv0+node_8089.g*float2(0,0.2));
