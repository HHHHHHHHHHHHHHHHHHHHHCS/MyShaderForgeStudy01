...
////// Lighting:
////// Emissive:
                float4 node_8663 = _Time;
                float2 node_1532 = (i.uv0+node_8663.g*float2(0,0.2));
                float4 _SecondTexture_var = tex2D(_SecondTexture,TRANSFORM_TEX(node_1532, _SecondTexture));
                float4 node_7813 = _Time;
                float3 node_1063 = (_SecondTexture_var.rgb*_SecondColor.rgb*distance(i.uv0.g,(1.0 - saturate(sin(node_7813.g)))));
